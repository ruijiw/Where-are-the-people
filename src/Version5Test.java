...
public class Version5Test {
	...
	private Version5 ver;
	
    @Test(timeout = TIMEOUT)
    public void testFindCorners() {
    	ver = new Version5(PopulationQuery.parse("CenPop2010.txt"), 10000, 100, 500);
    ...
    public void testCalculateQuery1() {
    	ver = new Version5(PopulationQuery.parse("CenPop2010.txt"), 10000, 20, 25);
        Rectangle rect = ver.findCorners();
    ...
    public void testCalculateQuery7() {
    	ver = new Version5(PopulationQuery.parse("CenPop2010.txt"), 10000, 9, 14);
        Rectangle rect = ver.findCorners();
    ...
    public void testCalculateQuery9() {
    	ver = new Version5(PopulationQuery.parse("sample.txt"), 2, 5, 5);
        Rectangle rect = ver.findCorners();
