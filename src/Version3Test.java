...
public class Version3Test {
	...
	private Version3 ver;
	
    @Test(timeout = TIMEOUT)
    public void testFindCorners() {
    	ver = new Version3(PopulationQuery.parse("CenPop2010.txt"), 100, 500);
    ...
    public void testCalculateQuery1() {
    	ver = new Version3(PopulationQuery.parse("CenPop2010.txt"), 20, 25);
        Rectangle rect = ver.findCorners();
    ...
    public void testCalculateQuery7() {
    	ver = new Version3(PopulationQuery.parse("CenPop2010.txt"), 9, 14);
        Rectangle rect = ver.findCorners();
    ...
    public void testCalculateQuery9() {
    	ver = new Version3(PopulationQuery.parse("sample.txt"), 5, 5);
        Rectangle rect = ver.findCorners();
